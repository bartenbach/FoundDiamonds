...
public class FoundDiamonds extends JavaPlugin {
    ...
    /*
     * TODO: MenuHandler set area? Is clean logging in SQL a popular request?
     * Customizable admin message formats! Customizable light level message formats!
     */
    ...
    /*
     * private void startMetrics() { if (getConfig().getBoolean(Config.metrics)) {
     * try { MetricsLite metrics = new MetricsLite(this); metrics.start(); } catch
     * (IOException e) { this.log.warning("Metrics failed to start - Ignoring."); }
     * } }
     */
}
